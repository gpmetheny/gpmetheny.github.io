            ...
            <form action="https://formspree.io/gabbie.metheny@gmail.com" method="POST">
              ...
              <div className="form-row">
                <div className="form-group offset-lg-2 col-lg-5 mb-0">
                  <label className="mb-0" htmlFor="firstName"><small>First Name<span> *</span></small></label>
                ...
                <div className="form-group col-lg-5 mb-0">
                  <label className="mb-0" htmlFor="lastName"><small>Last Name<span> *</span></small></label>
              ...
              <div className="form-row">
                <div className="form-group offset-lg-2 col-lg-5 mb-0">
                  <label className="mb-0" htmlFor="jobTitle"><small>Job Title</small></label>
                  <input type="text" className="form-control" name="jobTitle" id="jobTitle" />
                </div>
                <div className="form-group col-lg-5 mb-0">
                  <label className="mb-0" htmlFor="company"><small>Company</small></label>
              ...
              <div className="form-row">
                <div className="form-group offset-lg-2 col-lg-10 mb-0">
                  <label className="mb-0" htmlFor="_replyto"><small>Email<span> *</span></small></label>
