  ...
  render() {
    return (
      <div className="jumbotron jumbotron-fluid content-wrapper" id="contact">
        <div className="d-flex align-items-center justify-content-center my-auto contact-wrapper ">
          <div className="container d-flex flex-column flex-md-row align-items-center justify-content-center px-md-5">
            <div>
