              ...
              <div className="col-md-8">
                <div className="container">
                  ...
                  <div className="row text-center">
                    <Link to="/resume" className="more col-12 col-md-6 col-lg-4 offset-lg-1">see my resume</Link>
                    <Link to="contact" className="more col-12 col-md-6 col-lg-4 offset-lg-2">get in touch {'>>'}</Link>
                  </div>
