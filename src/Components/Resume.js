          ...
          <div className="row">
            <div className="col-md-7 col-lg-8">
              ...
              <div>
                ...
                <p>I create engaging, accessible user experiences, including original designs and animations. I am experienced in the most common front-end libraries and frameworks, and I recently rebuilt my <Link to="/">portfolio website</Link> using React and Styled Components. You can see some of my <Link to="/work">animations</Link> there as well.</p>
                <p>While first learning JavaScript, I created a <a href="https://pb-livin.github.io/bojack-ipsum" target="_blank" rel="noopener noreferrer">lorem ipsum generator</a> that randomly generates dummy text from <a href="https://www.netflix.com/title/70300800" target="_blank" rel="noopener noreferrer">Netflix's <em>BoJack Horseman</em></a>. In need of a reliable way to get episode transcripts, I wrote a Node.js parser that converts Netflix subtitles (XML-formatted) into proper transcript text files, complete with human-readable timestamps. It works on nearly all of Netflix's content, including subtitles in many different languages.</p>
                <p>As a freelance developer working as part of a remote team, I cooperatively built a responsive single page quiz app for a large company, and in the process learned a lot about handling animations in React! I also led a complete redesign of a static website for a professional speaker.</p>
