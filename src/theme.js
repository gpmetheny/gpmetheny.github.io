...
const theme = {
  light: {
    color: {
      ...
      primary: _white,
      primaryTransparent: 'rgba(255, 255, 255, .6)',
      contrast: _black,
      contrastTransparent: 'rgba(0, 0, 0, .7)',
      contrastMild: lighten(_gray, 100),
      contrastMedium: darken(_gray, 20),
      black: _black,
  ...
  dark: {
    color: {
      ...
      logoInvert: invert(_logo),
      primary: _black,
      primaryTransparent: 'rgba(0, 0, 0, .6)',
      contrast: _white,
      contrastTransparent: 'rgba(255, 255, 255, .6)',
      contrastMild: darken(_gray, 80),
      contrastMedium: lighten(_gray, 20),
      black: _black,
      blackLight: lighten(_black, 40),
      white: _white,
      gray: _gray
